...
\bibitem{gated-graph-conv-paper} Yujia Li, Daniel Tarlow, Marc Brockschmidt and Richard Zemel. <<Gated Graph Sequence Neural Networks>>. \textit{ArXiv abs:1511.05493} (2016).
...
\bibitem{ap-vs-roc-auc-paper} Takaya Saito and Marc Rehmsmeier. <<The Precision-Recall Plot Is More Informative than the ROC Plot When Evaluating Binary Classifiers on Imbalanced Datasets>>. In \textit{PLoS ONE}, vol. 10, 2015.
...
% todo: adopt \bibitem{negative-sampling-paper} Tomas Mikolov, Ilya Sutskever, Kai Chen, Greg Corrado and Jeffrey Dean. <<Distributed Representations of Words and Phrases and their Compositionality>>. \textit{ArXiv abs:1310.4546} (2013).
